		...
		<div class="row">
			<div class="col-xs-12 col-sm-7">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" name="id" id="form-field-1-1" value="<?php echo $id; ?>" />
						<input type="text" name="judul" id="form-field-1-1" placeholder="Judul" class="col-xs-9" required value="<?php echo $judul; ?>" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="date" name="tgl" id="form-field-2" class="col-xs-9" required value="<?php echo $tgl; ?>" />
					</div>
				</div>
				...
				<div class="col-sm-9">
						<div class="clearfix">
							...
							<textarea name="isi" data-provide="markdown" data-iconlibrary="fa" rows="10"><?php echo $isi; ?></textarea>
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="file" name="file" id="id-input-file-1" class="form-control" value=""><?php echo $image; ?>
					</div>
				</div>
			</div>
		</div>
