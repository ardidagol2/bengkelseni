				...
				<div class="widget-box">
					...
					<div class="clearfix form-actions">
						<div class="col-md-offset-3 col-md-9">
							...
							&nbsp; &nbsp; &nbsp;
							&nbsp; &nbsp; &nbsp;
							<a class="btn btn-info" href="<?php echo base_url(); ?>admin/kelastari/tambah">
								<i class="ace-icon fa fa-check bigger-110"></i>
								Tambah
							</a>

							&nbsp; &nbsp; &nbsp;
							<a class="btn" href="<?php echo base_url(); ?>admin/kelastari/View">
