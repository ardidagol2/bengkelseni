...
<?php echo form_open_multipart('admin/kelastari/simpan', 'class="form-horizontal"') ?>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-7">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" hidden name="id" id="form-field-1-1" value="<?php echo $this->model_tari->get_kodeunik('berita'); ?>" />
