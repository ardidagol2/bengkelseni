			...
			<table id="dynamic-table" class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						...
						<th class="hidden-480 center">Item</th>
						<th class="hidden-480 center">Panjang Lukisan</th>
						<th class="hidden-480 center">Total Biaya</th>
				...
				<tbody>
					...
					foreach ($data->result() as $row) {
						?>
						<td><?php echo $row->no_layanan; ?></td>
						<td><?php echo $row->nama; ?></td>
						<td><?php echo $row->no_id; ?></td>
						<td><?php echo $row->telp; ?></td>
						<td><?php echo $row->email; ?></td>
						<td><?php echo $row->item; ?></td>
						<td><?php echo $row->panjang_lukisan; ?></td>
