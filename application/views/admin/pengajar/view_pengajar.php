					...
					foreach ($data->result() as $row) {
						...
						<td>
							<div class="hidden-sm hidden-xs btn-group">
								<a class="btn btn-xs btn-info" href="<?php echo base_url(); ?>admin/pengajar/edit/<?php echo $row->id_pengajar; ?>" onclick="return confirm('Anda yakin ingin mengubah data..??')">
								<i class="ace-icon fa fa-pencil bigger-120"></i>
								</a>

								<!-- <a class="btn btn-xs btn-danger" href="<?php echo base_url(); ?>admin/pengajar/hapus/<?php echo $row->id_pengajar; ?>" onclick="return confirm('Anda yakin ingin menghapus data..??')">
